						...
						<div class="kt-timeline-v2__items  kt-padding-top-25 kt-padding-bottom-30">
							...
							<div class="kt-timeline-v2__item">
								...
								<div class="kt-list-pics kt-list-pics--sm kt-padding-l-20">
									<a href="#"><img src="{{ asset("assets/media/users/100_13.jpg") }} " title=""></a>
									<a href="#"><img src="{{ asset("assets/media/users/100_11.jpg") }} " title=""></a>
									<a href="#"><img src="{{ asset("assets/media/users/100_14.jpg") }} " title=""></a>
								</div>
							</div>
							<div class="kt-timeline-v2__item">
				...
				<div class="kt-portlet__body">
					<div class="kt-widget3">
						...
						<div class="kt-widget3__item">
							<div class="kt-widget3__header">
								<div class="kt-widget3__user-img">
									<img class="kt-widget3__img" src="{{asset("assets/media/users/user4.jpg")}}" alt="">
								</div>
								<div class="kt-widget3__info">
									<a href="#" class="kt-widget3__username">
										Lebron King James
						...
						<div class="kt-widget3__item">
							<div class="kt-widget3__header">
								<div class="kt-widget3__user-img">
									<img class="kt-widget3__img" src="{{asset("assets/media/users/user5.jpg")}}" alt="">
								</div>
								<div class="kt-widget3__info">
									<a href="#" class="kt-widget3__username">
										Deb Gibson
