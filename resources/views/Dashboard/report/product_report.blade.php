                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                <input type="text" autocomplete="off" id="from-date"  class="form-control datepicker-date"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                <input type="text" autocomplete="off" id="to-date"  class="form-control datepicker-date"
                                       placeholder="اختر التاريخ"/>
                                <div class="input-group-append">
                                        <span class="input-group-text"><i
                                                class="la la-calendar glyphicon-th"></i></span>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select name="product_id" class="form-control select_2 product_id" >
                                <option value="">اختر</option>
                    ...
                    <div class="row col-md-12 product_table">
                        @if(isset($product_report))
                            @include("Dashboard.report.product_report_table" , ["product_report"  => $product_report])
                        @endif
