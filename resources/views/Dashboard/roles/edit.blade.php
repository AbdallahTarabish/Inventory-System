...
@section('content')
    <?php
    breadCrumb(config("breadcrumb.edit_roles"));
    ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="name" class="form-control" placeholder="ادخل الاسم" value="{{old('name',$role->name)}}"/>
                                            ...
                                            <td>
                                                ...
                                                <select name="permissions[]" class="form-control select_2" multiple>
                                                    @foreach($permission_maps as $key_map=>$permission_map)
                                                        <option value="{{$key_model.'_'.$key_map}}"
                                                            {{ $role->hasPermission($key_model.'_'.$key_map) ? 'selected' : '' }}>{{$permission_map}}</option>
                                                    @endforeach
                                                </select>
                                            </td>
                                        </tr>
